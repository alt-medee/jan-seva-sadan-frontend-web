      ...
      <div className="container mx-auto px-5 md:px-12 pt-8 md:pt-12 pb-0">
        ...
        <div className="hidden md:grid md:grid-cols-[1.1fr_1px_1.4fr]">
          ...
          <div className="pb-10 pr-10">
            <div className="flex items-center gap-3 mb-1">
              ...
              <div>
                ...
                <p className="text-[10px] text-white/30 uppercase tracking-[0.14em] mt-0.5">Samastipur</p>
              </div>
            </div>

            {/* <p className="text-[13px] text-white/35 leading-relaxed mt-4 max-w-[220px]">
              Trusted and affordable healthcare, available around the clock.
            </p> */}
            ...
            <div className="inline-flex items-center gap-1.5 bg-white/[0.06] border border-white/10 rounded-full px-3 py-1 mt-5">
              ...
              <span className="text-[11px] text-white/35">Open 24/7</span>
            </div>

            <div className="flex gap-2 mt-5">
              <a href="#" target="_blank" className="w-[34px] h-[34px] flex items-center justify-center rounded-lg border border-white/12 bg-white/[0.04] hover:bg-white/10 hover:border-white/25 transition-all duration-200">
          ...
          <div className="pb-10 pl-10">
            <p className="text-[10px] font-medium text-white/30 uppercase tracking-[0.13em] mb-[18px]">
              Contact Info
            </p>
            <div className="grid grid-cols-2">

              <div className="flex items-start gap-3 py-3 pr-5 border-b border-white/[0.06]">
                <div className="w-[30px] h-[30px] rounded-lg border border-white/[0.09] bg-white/[0.04] flex items-center justify-center shrink-0 mt-0.5">
                  <MapPin className="w-3.5 h-3.5 text-white/40" />
                </div>
                <div>
                  <p className="text-[10px] text-white/30 uppercase tracking-[0.08em] mb-0.5">Address</p>
              ...
              <div className="flex items-start gap-3 py-3 pl-5 border-b border-white/[0.06] border-l border-l-white/[0.06]">
                <div className="w-[30px] h-[30px] rounded-lg border border-white/[0.09] bg-white/[0.04] flex items-center justify-center shrink-0 mt-0.5">
                  <Phone className="w-3.5 h-3.5 text-white/40" />
                </div>
                <div>
                  <p className="text-[10px] text-white/30 uppercase tracking-[0.08em] mb-0.5">Phone</p>
                  <a href="tel:9798701014" className="block text-[13px] text-white/65 hover:text-white transition">9798701014</a>
                  <a href="tel:6204954262" className="block text-[13px] text-white/65 hover:text-white transition">6204954262</a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 py-3 pr-5">
                ...
                <div>
                  <p className="text-[10px] text-white/30 uppercase tracking-[0.08em] mb-0.5">Email</p>
                  <a href="mailto:sadanjpseva@gmail.com" className="text-[13px] text-white/65 hover:text-white transition">
                    sadanjpseva@gmail.com
                  </a>
                </div>
              </div>

              <div className="flex items-start gap-3 py-3 pl-5 border-l border-l-white/[0.06]">
                <div className="w-[30px] h-[30px] rounded-lg border border-white/[0.09] bg-white/[0.04] flex items-center justify-center shrink-0 mt-0.5">
                  <Clock className="w-3.5 h-3.5 text-white/40" />
                </div>
                <div>
                  <p className="text-[10px] text-white/30 uppercase tracking-[0.08em] mb-0.5">Hours</p>
                  <p className="text-[13px] text-white/65">24 घंटे, 7 दिन</p>
                </div>
              </div>
        ...
        <div className="md:hidden">
          <div className="flex items-center justify-between gap-3 pb-5 border-b border-white/[0.08] mb-5">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="text-[15px] font-medium tracking-wide leading-tight">J.P. Seva Sadan</h3>
                <p className="text-[10px] text-white/35 uppercase tracking-widest mt-0.5">Samastipur</p>
              </div>
            </div>
            <div className="flex gap-2">
              <a href="#" target="_blank" className="w-[34px] h-[34px] flex items-center justify-center rounded-lg border border-white/12 bg-white/[0.05] hover:bg-white/10 transition-all duration-200">
                <Facebook className="w-4 h-4 text-white/55" />
              </a>
              <a href="#" target="_blank" className="w-[34px] h-[34px] flex items-center justify-center rounded-lg border border-white/12 bg-white/[0.05] hover:bg-white/10 transition-all duration-200">
          ...
          <p className="text-[10px] font-medium text-white/30 uppercase tracking-wider mb-3">Contact Info</p>
